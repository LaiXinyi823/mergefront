  ...
  <el-container>
      <el-aside width="95%" height="100%" class="originKG">
        <el-card shadow="always">
          ...
          <div class="block">
            <el-image :src="src" style="width:40%;height:50%;margin-left:30%;"></el-image>
          </div>
          <h5 style="color:#800000;">提示：新增4个实体，对应3种关系</h5>
          <h4 style="float:left;margin:0;">显示层数：</h4>
          <el-input-number size="mini" v-model="num1" style="float:left"></el-input-number>
          <h4 style="float:left;margin:0;margin-left:30px;">显示条数：</h4>
          <el-input-number size="mini" v-model="num2" style="float:left"></el-input-number>
          <el-button type="primary" plain >确认融合</el-button>
        </el-card>
      </el-aside>
    </el-container>
</template>

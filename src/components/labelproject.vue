    ...
    <div v-if="opt == 'projectDetail'" style="width: 100%; height: 100px; background: white">
      ...
      <div style="width: 100%; margin-top: 5px">
        <el-tabs type="border-card">
          <el-tab-pane>
            <span slot="label"><i class="el-icon-document"></i>标注数据</span>
            <el-form ref="form" :model="form" label-width="100px">
                <el-form-item label="标注方式：">
                    <el-radio v-model="form.dataType" label="DB">DB</el-radio>
                    <el-radio v-model="form.dataType" label="Text">Text</el-radio>
                </el-form-item>
                <!-- 以数据库的形式进行标注 -->
                <el-form-item v-if="form.dataType=='DB'" label="选择数据：">
                    <el-select v-model="form.DBname" placeholder="请选择数据库来源">
                    <el-option label="DB_1" value="shanghai"></el-option>
                    <el-option label="DB_2" value="beijing"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item v-if="form.dataType=='DB'" label="选择模型：">
                    <el-select v-model="form.DBname" placeholder="请选择模型">
                    <el-option label="Model_1" value="shanghai"></el-option>
                    <el-option label="Model_2" value="beijing"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item v-if="form.dataType=='DB'">
                    <el-button type="primary">开始标注</el-button>
                    <el-button @click="tempDialogVisible=true">暂存</el-button>
                </el-form-item>                  
            </el-form>  
            <!-- 以单个文本生成子图的形式进行标注 -->
            <div v-if="form.dataType=='Text'">
                <div style="float:left;">
                    ...
                    <!-- 生成知识图谱子图 -->
                    <el-aside width="700px" height="100%" class="childKG">
                        <el-card shadow="always">
                ...
                <el-aside width="540px" height="100%" style="margin-top:10px;float:right">
                    <el-form ref="form" v-if="form.dataType=='Text'" :model="form" label-width="100px">
            ...
            <el-dialog title="暂存" :visible.sync="tempDialogVisible">

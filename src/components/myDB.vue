<template>
  <el-container>
    <div v-if="opt == 'DBList'">
      ...
      <el-dialog title="添加文本数据" :visible.sync="addDialogVisible">
        <el-form :model="newDB">
            ...
            <div v-if="method=='DB'">
                <el-form-item label="数据名称" :label-width="formLabelWidth">
                    <el-input v-model="newDB.name" autocomplete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item label="ip" :label-width="formLabelWidth">
                    <el-input v-model="newDB.ip" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="port" :label-width="formLabelWidth">
                    <el-input v-model="newDB.port" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="username" :label-width="formLabelWidth">
                    <el-input v-model="newDB.username" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="password" :label-width="formLabelWidth">
                    <el-input v-model="newDB.password" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="db" :label-width="formLabelWidth">
                    <el-input v-model="newDB.db" autocomplete="off"></el-input>
                </el-form-item>
            </div>
    ...
    <div v-if="opt == 'DBDetail'" style="width: 100%; height: 100px; background: white">
